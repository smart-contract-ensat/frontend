...
export class AccountControllerService extends BaseService {
  ...
  save4$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, AccountControllerService.Save4Path, 'post');
    if (params) {
  ...
  findById4$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, AccountControllerService.FindById4Path, 'get');
    if (params) {
  ...
  delete4$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, AccountControllerService.Delete4Path, 'delete');
    if (params) {
      rb.path('account-id', params['account-id'], {});
    }
