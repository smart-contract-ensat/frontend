...
export class AddressControllerService extends BaseService {
  ...
  findAll3$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, AddressControllerService.FindAll3Path, 'get');
    if (params) {
    }
  ...
  save3$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, AddressControllerService.Save3Path, 'post');
    if (params) {
  ...
  findById3$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, AddressControllerService.FindById3Path, 'get');
    if (params) {
  ...
  delete3$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, AddressControllerService.Delete3Path, 'delete');
    if (params) {
      rb.path('address-id', params['address-id'], {});
    }
