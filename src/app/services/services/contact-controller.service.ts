...
export class ContactControllerService extends BaseService {
  ...
  findAll2$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ContactControllerService.FindAll2Path, 'get');
    if (params) {
    }
  ...
  findById2$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ContactControllerService.FindById2Path, 'get');
    if (params) {
  ...
  delete2$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ContactControllerService.Delete2Path, 'delete');
    if (params) {
      rb.path('contact-id', params['contact-id'], {});
    }
  ...
  findAllByUserId1$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ContactControllerService.FindAllByUserId1Path, 'get');
    if (params) {
