...
export class StatisticsControllerService extends BaseService {
  ...
  findSumTractionsByDate$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, StatisticsControllerService.FindSumTractionsByDatePath, 'get');
    if (params) {
  ...
  highestTransfer$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, StatisticsControllerService.HighestTransferPath, 'get');
    if (params) {
      rb.path('user-id', params['user-id'], {});
    }
  ...
  highestDeposit$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, StatisticsControllerService.HighestDepositPath, 'get');
    if (params) {
      rb.path('user-id', params['user-id'], {});
    }
  ...
  getAccountBalance$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, StatisticsControllerService.GetAccountBalancePath, 'get');
    if (params) {
      rb.path('user-id', params['user-id'], {});
    }
