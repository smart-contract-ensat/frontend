...
export class TransactionControllerService extends BaseService {
  ...
  findById1$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TransactionControllerService.FindById1Path, 'get');
    if (params) {
  ...
  delete1$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TransactionControllerService.Delete1Path, 'delete');
    if (params) {
      rb.path('transaction-id', params['transaction-id'], {});
    }
  ...
  findAllByUserId$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TransactionControllerService.FindAllByUserIdPath, 'get');
    if (params) {
