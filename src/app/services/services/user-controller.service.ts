...
export class UserControllerService extends BaseService {
  ...
  save$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, UserControllerService.SavePath, 'post');
    if (params) {
  ...
  validateAccount$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, UserControllerService.ValidateAccountPath, 'patch');
    if (params) {
  ...
  invalidateAccount$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, UserControllerService.InvalidateAccountPath, 'patch');
    if (params) {
      rb.path('user-id', params['user-id'], {});
    }
